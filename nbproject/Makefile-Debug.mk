...
${OBJECTDIR}/arreglossimples.o: arreglossimples.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/arreglossimples.o arreglossimples.c
...
${OBJECTDIR}/if.o: if.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/if.o if.c
...
${OBJECTDIR}/recursosmath.o: recursosmath.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/recursosmath.o recursosmath.c
